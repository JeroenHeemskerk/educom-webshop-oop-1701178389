...
class ContactDoc extends FormDoc {
    protected function showFormContent(){
        ...
        $this->showFormField('str', 'Straatnaam:', 'str', 'Vul hier uw straatnaam in');
        $this->showFormField('strnr', 'Huisnummer:', 'strnr', 'Vul hier uw huisnummer in');
        $this->showFormField('zpcd', 'Postcode:', 'zpcd', 'Vul hier uw postcode in');
        $this->showFormField('resid', 'Woonplaats:', 'resid', 'Vul hier uw woonplaats in');
